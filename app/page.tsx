        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden lg:flex items-center space-x-4">
              <Link href="/demo" className="text-secondary-600 hover:text-secondary-900">
                Demo
              </Link>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-secondary-900 mb-6">
              Create Forms That
              <span className="text-primary-600 block">Actually Convert</span>
            </h1>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-secondary-700">AI generates relevant questions</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-primary-100 rounded-full flex items-center justify-center">
                    <Palette className="w-4 h-4 text-primary-600" />
                  </div>
                  <span className="text-secondary-700">Build beautiful landing pages</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-primary-100 rounded-full flex items-center justify-center">
                    <Sparkles className="w-4 h-4 text-primary-600" />
                  </div>
                  <span className="text-secondary-700">Get AI-generated content</span>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-primary-50 to-secondary-50 rounded-2xl p-8 border border-primary-200">
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <h3 className="text-lg font-semibold text-primary-900">AI Content Preview</h3>
                </div>
                
                <div className="space-y-4">
                  <div>
                    <h4 className="font-medium text-secondary-900 mb-2">{aiContentExample.title}</h4>
                    <p className="text-sm text-secondary-700">{aiContentExample.summary}</p>
                  </div>
                  ...
                  <div>
                    <h5 className="font-medium text-secondary-900 mb-2">Recommendations</h5>
                    <ul className="space-y-1">
